  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white hover:shadow-glow transition-bounce font-semibold shadow-medium",
        upload: "gradient-primary text-white hover:shadow-glow transition-bounce font-medium shadow-soft border-2 border-transparent hover:border-primary-light",
        success: "gradient-secondary text-white hover:shadow-medium transition-smooth font-medium shadow-soft",
        accent: "gradient-accent text-white hover:shadow-medium transition-smooth font-medium shadow-soft",
      },
      size: {
